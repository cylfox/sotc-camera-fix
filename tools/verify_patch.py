"""Verify live memory matches the shipped v15 pnach."""
import os, sys
...
EXPECTED = [
    ...
    (0x001A498C, 0x1420000A, "TrA: bne at, zero, DEADZONE(+10)"),
    ...
    (0x001A49A0, 0x14200005, "TrA: bne at, zero, DEADZONE(+5) ; aim != 1 -> deadzone"),
    (0x001A49A4, 0x00000000, "TrA: nop"),
    (0x001A49A8, 0x92480108, "TrA: lbu t0, 0x108(s2)"),
    (0x001A49AC, 0xA2080056, "TrA: sb t0, 0x56(s0)"),
    (0x001A49B0, 0x08069273, "TrA: j 0x001A49CC (RET)"),
    (0x001A49B4, 0x00000000, "TrA: nop"),
    (0x001A49B8, 0x2441FFBF, "TrA: addiu at, v0, -0x41 (DEADZONE)"),
    (0x001A49BC, 0x2C21007F, "TrA: sltiu at, at, 0x7F"),
    (0x001A49C0, 0x10200002, "TrA: beq at, zero, RET(+2)"),
    (0x001A49C4, 0x00000000, "TrA: nop"),
    (0x001A49C8, 0x240200C0, "TrA: addiu v0, zero, 0xC0"),
    (0x001A49CC, 0x0806B353, "TrA: j 0x001ACD4C (RET)"),
    (0x001A49D0, 0xA2020057, "TrA: sb v0, 0x57(s0)"),
    ...
    (0x001A5254, 0x14200005, "TrB: bne at, zero, RET(+5)"),
    (0x001A5258, 0x00000000, "TrB: nop"),
    (0x001A525C, 0x8D01C880, "TrB: lw at, -0x3780(t0) ; cinematic flag"),
    (0x001A5260, 0x10200002, "TrB: beq at, zero, RET(+2) ; cinematic -> skip"),
    (0x001A5264, 0x00000000, "TrB: nop"),
    (0x001A5268, 0xC50CDF00, "TrB: lwc1 $f12, -0x2100(t0) ; camera yaw override"),
    (0x001A526C, 0x0845DAAF, "TrB: j 0x01176ABC (RET)"),
    (0x001A5270, 0x00000000, "TrB: nop [jump delay]"),
]
